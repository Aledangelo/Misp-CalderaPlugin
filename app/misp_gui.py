...
class MispGUI(BaseWorld):
    ...
    async def start(self, request):
        ...
        await self.misp_svc.save_operation(op_name=event['Event']['info'] + "_Op", adv_name=event['Event']['info'] + "_Adv", adv_description="Generated by Plugin", abilities=my_abilities)
